...
function varargout = pop_newtimef_timewarp(EEG, typeproc, num, tlimits, cycles, varargin );

varargout{1} = '';
% display help if not enough arguments
% ------------------------------------
if nargin < 2
	help pop_newtimef_timewarp;
	return;
end;	
lastcom = [];
if nargin < 3
...
if popup
    ...
    g = [1 0.3 0.6 0.4];
	geometry = { g g g g g g g g [0.975 1.27] [1] [1.2 1 1.2] [2 1]};
    uilist = { ...
			   ...
			   { 'Style', 'checkbox', 'value', 0, 'string', ...
                 ...
                 { 'Style', 'edit', 'string', '1 2 ' 'tag' 'twEvents' }...
    ...
    for i = 1:EEG.trials;
    eventms(i,:)=[EEG.epoch(i).eventlatency{twEvents}];
end;
