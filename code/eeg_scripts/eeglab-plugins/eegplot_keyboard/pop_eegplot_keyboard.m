...
if icacomp == 1
	eegplot_keyboard( EEG.data, 'srate', EEG.srate, 'title', 'Scroll channel activities -- eegplot()', ...
	...
	eegplot_keyboard( tmpdata, 'srate', EEG.srate, 'title', 'Scroll component activities -- eegplot()', ...
			 'limits', [EEG.xmin EEG.xmax]*1000 , 'command', command, eegplotoptions{:}, varargin{:}); 
end;
