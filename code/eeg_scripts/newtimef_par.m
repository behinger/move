...
function [P,R,mbase,timesout,freqs,Pboot,Rboot,alltfX,PA] = newtimef_par( data, frames, tlimits, Fs, varwin, varargin);
...
if isempty(g.precomputed)
    ...
    [alltfX freqs timesout R] = timefreq_par(data, g.srate, tmioutopt{:}, ...
